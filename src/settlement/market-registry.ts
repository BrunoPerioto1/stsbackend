...
export const MARKET_REGISTRY: readonly MarketDefinition[] = [
  ...
  ...definitions(['AMBOS_TEMPOS_COM_GOL','TIME_MARCA_EM_AMBOS_TEMPOS','VENCER_UM_DOS_TEMPOS','VENCER_AMBOS_TEMPOS'],['SCORE_PERIODS'],parsePeriods,evaluatePeriods,'PARCIAL'),
